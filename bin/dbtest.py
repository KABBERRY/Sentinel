...
pr = Proposal(
    name='proposal7',
    url='https://primestonecentral.com/proposal7',
...
# TODO: make this a test, mock 'primestoned' and tie a test block height to a
# timestamp, ensure only unit testing a within_window method
#
# also, create the `within_window` or similar method & use that.
#
bh = 131112
bh_epoch = primestoned.block_height_to_epoch(bh)
